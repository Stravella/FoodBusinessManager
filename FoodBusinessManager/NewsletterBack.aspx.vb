        ...
        Try
            ...
            If Current.Session("accion") = "Enviar" Then
                ...
                For Each subscriptor As SubscriptorDTO In newsletter.Categoria.subscriptores
                    ...
                    GestorMailBLL.ObtenerInstancia.EnviarMail(subscriptor.mail, "Food Business Manager : " & newsletter.Titulo, "<img src=" & newsletter.Imagen.Img64 & "> <br/> <br/>" & newsletter.Cuerpo & "<br/> <br/> Ustéd esta recibiendo este mensaje por qué está subscripto al newsletter. Para desubscribirse, haga click aquí: " + "<a href=" + ActiveURL + ">link</a>" + "<br /><br /> Si no te funciona el link, copia y pega esta dirección: " + ActiveURL, Server.MapPath("\EmailTemplates\Template_mail.html"))
