            ...
            <div class="col">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <hr />
                        <%-- Respuestas --%>
                        <asp:GridView ID="gvRespuestas" runat="server" CssClass="table table-hover table-bordered table-success" AutoGenerateColumns="false" EmptyDataText="No hay respuestas disponibles" HorizontalAlign="Center" AllowPaging="false" RowStyle-Height="40px">
