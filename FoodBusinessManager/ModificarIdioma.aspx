                ...
                <div class="card">
                    <div class="card-header">
                        <div class="row">
                            <div class="col">
                                <h2>
                                    <asp:Label ID="lbl_ModificarIdiomaTitulo" runat="server" Text="Modificar Idioma"></asp:Label>
                                </h2>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col">
                                <label>
                                    <asp:Label ID="lblSeleccioneCultura" runat="server" Text="Selección de cultura"></asp:Label>
                                </label>
                                <div class="form-group">
                                    <asp:DropDownList ID="lstCulturasCreadas" runat="server" AutoPostBack="true" CssClass="form-control"></asp:DropDownList>
                                </div>
                            </div>
                        </div>
                        <br />
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="form-group">
                                    <asp:Button ID="btn_modificarIdioma" runat="server" Text="Modificar Idioma" CssClass="btn btn-block btn-warning" />
                                </div>
                            </div>
                        </div>
                    </div>
