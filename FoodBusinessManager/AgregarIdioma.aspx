<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage.Master" CodeBehind="AgregarIdioma.aspx.vb" Inherits="FoodBusinessManager.Idiomas" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Contenido" runat="server">
    ...
    <form id="form1" runat="server">
        <div align="center">
            ...
            <div>
                <h1>
                    <asp:Label ID="lbl_AgregarIdiomaTitulo" runat="server" Text="Agregar Idioma" CssClass="labels"></asp:Label>
                </h1>
            </div>
            <br />
            <div>
            ...
            <br />
            <div>
                <asp:Button ID="btn_crearIdioma" runat="server" Text="Agregar Idioma" CssClass="mybutton" />
            </div>
            <br />
            <br />
        </div>
