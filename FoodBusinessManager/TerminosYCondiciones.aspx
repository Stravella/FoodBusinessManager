                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col">
                                ...
                                <p>
                                    <asp:Label ID="lblCondicionesUso" CssClass="text-justify" runat="server" Text="El servicio que Affiniti Solutions brinda al usuario (en adelante 'Usuario') lo es en virtud de los términos y condiciones del presente Acuerdo de Términos y Condiciones del servicio y de conformidad con las normas de operación y disposiciones publicadas periódicamente por Beauty Supply. El presente documento supone el acuerdo completo entre el Usuario y el Titular y prevalece sobre cualquier acuerdo anterior suscrito por las partes en relación con el objeto del presente. El presente aviso de información legal regula el uso del servicio ofrecido y el Titular pone a disposición de los usuarios de Internet a sus efectos."></asp:Label>
                                </p>
                            </div>
                        </div>
                        <div class="row">
